...
public class BitmapUtil {
     ...
     * @param edgeLength   Hope to get part of the side length of square,To a minimum
     ...
     * @param newWidth  set bitmap width
     * @param newHeight set bitmap height
     * @return Bitmap
     */
