...
public class SharedPreferenceUtil {
     ...
     * @param object  (String,Integer,Boolean,Float,Long) The key of key/value pair
     */
    ...
    public static void put(Context context, String fileName, String key, Object object) {
        if (null == object) {
            LogUtil.d(TAG, "object cannot be null");
            return;
        }
     ...
     * @param context
     * @param key
     * @param defaultObject What type of data cannot be NULL, what type of variable should
     *                      be
     * @return
     */
